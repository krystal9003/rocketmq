...
public class RequestCode {
    ...
    /** broker SendMessageProcessor 处理的请求 **/
    ...
    /** broker PullMessageProcessor 处理的请求 **/
    public static final int PULL_MESSAGE = 11;
    /** broker PullMessageProcessor 处理的请求 **/

    /** broker QueryMessageProcessor **/
    public static final int QUERY_MESSAGE = 12;
    public static final int VIEW_MESSAGE_BY_ID = 33;
    /** broker QueryMessageProcessor **/


    /** broker ConsumerManageProcessor **/
    ...
    public static final int GET_CONSUMER_RUNNING_INFO = 307; // ClientRemotingProcessor AminBrokerProcessor

    public static final int QUERY_CORRECTION_OFFSET = 308;

    public static final int CONSUME_MESSAGE_DIRECTLY = 309; // ClientRemotingProcessor AminBrokerProcessor
    ...
    /** broker ClientManageProcessor 处理3个请求 **/
    ...
    /** EndTransactionProcessor 处理1个请求 **/
